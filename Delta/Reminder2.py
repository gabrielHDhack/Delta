...
class ReminderApp:
    def __init__(self, root):
        ...
        self.task_label = Label(root, text="Task:", bg='#1e1e1e', fg='white', font=('Arial', 12, 'bold'))
        self.task_label.grid(row=0, column=0, padx=10, pady=10)

        self.task_entry = Entry(root, bg='#333333', fg='white', font=('Arial', 12))
        self.task_entry.grid(row=0, column=1, padx=10, pady=10)

        self.date_time_label = Label(root, text="Date/Time (Format: day/month/year hour:minute AM/PM):", bg='#1e1e1e', fg='white', font=('Arial', 12, 'bold'))
        self.date_time_label.grid(row=1, column=0, padx=10, pady=10)

        self.date_time_entry = Entry(root, bg='#333333', fg='white', font=('Arial', 12))
        self.date_time_entry.grid(row=1, column=1, padx=10, pady=10)

        self.add_button = Button(root, text="Add Reminder", command=self.add_reminder, bg='#333333', fg='white', font=('Arial', 12, 'bold'))
        self.add_button.grid(row=2, column=0, columnspan=2, padx=10, pady=10)

        self.reset_button = Button(root, text="Reset Reminder", command=self.reset_reminder, bg='#333333', fg='white', font=('Arial', 12, 'bold'))
        self.reset_button.grid(row=3, column=0, columnspan=2, padx=10, pady=10)
        self.reset_button.grid_remove()

        self.time_label = Label(root, text="", font=("Arial", 20), bg='#1e1e1e', fg='white')
