...
from patterns_and_responses import propt, times1, reminder_phrases, weather_queries, speech_off, name_change_keywords
import random 
import pywhatkit
import subprocess
...
class CommandProcessorThread(QThread):
    ...
    def run(self):
        ...
        while True:
            ...
            elif any(keyword in command for keyword in weather_queries):
...
#listen function
    @staticmethod
    def listen_for_command(timeout_seconds=7):
        try:
            with sr.Microphone() as source:
